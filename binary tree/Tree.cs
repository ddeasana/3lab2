...
namespace binary_tree
{
        ...
        {
            return new RectangleEnumerator<T>(Root);
        }
    ...
    public class RectangleEnumerator<T> : IEnumerator<T> where T : IComparable<T>
    {
        private BinaryTreeNode<T>? _root;
        private BinaryTreeNode<T>? _current;
        private bool movedNext = false;
        public RectangleEnumerator(BinaryTreeNode<T>? node)
        {
            _root = node;
        }
